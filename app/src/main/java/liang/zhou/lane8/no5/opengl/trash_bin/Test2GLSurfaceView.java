...
public class Test2GLSurfaceView extends GLSurfaceView
    ...
    public Test2GLSurfaceView(Context context) {
        this(context,null);

    }

    public Test2GLSurfaceView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        Bitmap bitmap = BitmapUtil.getBitmap(getContext());
